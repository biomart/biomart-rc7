...
<!--[if lt IE 7 ]> <body id="martexplorer" class="biomart layout2 ie6 "> <![endif]--> 
<!--[if IE 7 ]>    <body id="martexplorer" class="biomart layout2 ie7 "> <![endif]--> 
<!--[if IE 8 ]>    <body id="martexplorer" class="biomart layout2 ie8 "> <![endif]--> 
<!--[if !IE]><!--> <body id="martexplorer" class="biomart layout2"> <!--<![endif]--> 
        ...
        <div id="biomart-main" class="panel clearfix">
          <div class="steps">
            ...
            <div class="step clearfix filters items" style="display:none" data-step-number="2">
              <div id="biomart-filter-tree" class="item-tree"></div>
              <div id="biomart-filter-content" class="item-content"></div>
            </div>
            <div class="step clearfix attributes items" style="display:none" data-step-number="3">
              <div id="biomart-attribute-tree" class="item-tree"></div>
              <div id="biomart-attribute-content" class="item-content"></div>
            </div>
          </div>
        </div>
...
<div id="biomart-loading">
	<p class="message">
    <bm:message code="loading" capitalize="true"/> MartExplorer
	</p>
