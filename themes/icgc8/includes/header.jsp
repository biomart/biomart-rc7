        ...
        <div id="nav-blue" class="nav block block-menu region-odd even region-count-1 count-2" style="margin: 0pt;">
            <div class="content header-menu">
                ...
                <ul class="menu">
                    ...
                    <li class="leaf Data Summary"><a href="/pages/summary/" target="_self">Download Data</a></li>
                    ...
                    <li class="leaf Documentation"><a href="http://dcc.icgc.org/pages/docs/" target="_self">Documentation</a></li>
